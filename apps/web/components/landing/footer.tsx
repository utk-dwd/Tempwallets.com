        ...
        <div className="px-4 py-12 md:px-12 md:py-16 lg:px-24 xl:px-32">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 lg:gap-8">
              {/* Newsletter Section */}
              <div className="col-span-2 lg:col-span-1 w-full max-w-[300px]">
                <h3 className="text-base md:text-lg font-semibold mb-4 md:mb-6">Join a Newsletter</h3>
                <p className="text-white/80 font-light text-xs md:text-sm mb-4 md:mb-6">Your Email</p>
                <form onSubmit={handleSubmit} className="flex flex-row gap-2">
                  <Input
                    ...
                    className="bg-white/10 backdrop-blur-sm border-white/20 text-[hsl(var(--about-text))] placeholder:text-[hsl(var(--about-text-muted))] focus-visible:ring-white/30 text-sm flex-1"
                  />
                  <Button
                    variant="glass"
                    type="submit"
                    className="px-4 md:px-6 whitespace-nowrap text-sm"
                  >
                    Submit
                  </Button>
                </form>
                ...
                <div className="flex gap-3 md:gap-4 mt-6 md:mt-8">
                  <a
                    href="#"
                    className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center hover:bg-white/20 transition-colors"
                    aria-label="Dribbble"
                  >
